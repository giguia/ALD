  ...
  return (
    <>
      ...
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <ul>
          <li><Link to="/AdminDashboard"><i className="fas fa-qrcode"></i>Dashboard</Link></li>
          <li><Link to="/AdminUsers"><i className="fas fa-link"></i>Users</Link></li>
          <li><Link to="/AdminLeads"><i className="fas fa-stream"></i>Leads</Link></li>
          ...
          <li><Link to="#"><i className="fas fa-sliders-h"></i>Service</Link></li>
